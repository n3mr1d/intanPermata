...
function SakuraPetal({ className }: { className?: string }) {
    return (
        ...
        >
            ...
            <path d="M20 38C20 38 12 34 8 26C5.176 20.176 6 14 9 11C12 8 17.373 9 20 12C22.627 9 28 8 31 11C34 14 34.824 20.176 32 26C28 34 20 38 20 38Z" opacity="0.6" />
        </svg>
    );
}
...
function AsanohaPattern({ className }: { className?: string }) {
    return (
        ...
        >
            <defs>
                <pattern id="asanoha" patternUnits="userSpaceOnUse" width="40" height="40">
                ...
                {highlight && (
                    <>
                        ...
                        <span className="relative inline-block">
                            <span className="relative z-10 text-rose-500">{highlight}</span>
                            <span
                                aria-hidden="true"
...
function HeroAbout() {
    return (
        ...
        >
            ...
            <AsanohaPattern className="absolute inset-0 h-full w-full text-rose-200 opacity-40 [mask-image:radial-gradient(ellipse_at_center,black_20%,transparent_80%)]" />

            {/* Torii decoration */}
            <ToriiGate className="absolute right-12 top-0 h-40 w-auto text-rose-200 sm:right-24 sm:h-52" />
            <ToriiGate className="absolute -left-6 bottom-6 h-28 w-auto -scale-x-100 text-rose-100" />

            {/* Sakura petals */}
            <SakuraPetal className="absolute left-1/4 top-16 h-8 w-8 animate-[spin_12s_linear_infinite] text-rose-300" />
            <SakuraPetal className="absolute right-1/3 bottom-12 h-6 w-6 animate-[spin_18s_linear_infinite_reverse] text-rose-200" />
            <SakuraPetal className="absolute left-2/3 top-1/2 h-5 w-5 animate-[spin_20s_linear_infinite] text-rose-300" />

            {/* Kanji decorations */}

            <div
                aria-hidden="true"
                className="absolute left-6 top-8 select-none font-serif text-[5rem] font-bold text-rose-200"
            >
                道
            </div>
                ...
                <div className="grid items-center gap-16 lg:grid-cols-2">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative overflow-hidden rounded-3xl border border-rose-100 shadow-2xl shadow-rose-200/30">
                            ...
                            {/* Label overlay */}
                            <div className="absolute bottom-4 left-4 right-4 z-10 flex items-center gap-2 rounded-xl border border-white/30 bg-white/80 px-3 py-2 backdrop-blur-sm">
                        ...
                        <div className="absolute -right-4 -top-4 flex items-center gap-2.5 rounded-2xl border border-rose-100 bg-white px-4 py-2.5 shadow-lg shadow-rose-200/40">
                            ...
                            <div>
                                <p className="text-[9px] font-semibold uppercase tracking-widest text-rose-400">
                                    Tersertifikasi
                                </p>
                        ...
                        <div
                            aria-hidden="true"
                            className="absolute -bottom-3 -right-3 h-14 w-14 rounded-full border-4 border-white bg-rose-500/10"
                        />
                        <SakuraPetal className="absolute -bottom-1 -right-1 h-7 w-7 text-rose-400/50" />
                    </div>
...
function VisionMissionSection() {
    return (
        ...
        >
            ...
            />
            <AsanohaPattern className="absolute inset-0 h-full w-full text-rose-200/20 opacity-50 [mask-image:radial-gradient(ellipse_at_top_right,black_10%,transparent_70%)]" />

            {/* Kanji decoration */}
            <div
                aria-hidden="true"
                className="absolute right-10 top-10 select-none font-serif text-[9rem] font-bold text-rose-200/30"
            >
                夢
            </div>
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid gap-8 lg:grid-cols-2">
                    {/* Vision Card */}
                    <div className="group relative overflow-hidden rounded-3xl bg-white p-8 shadow-lg shadow-rose-100/50 ring-1 ring-rose-100 transition-all duration-500 hover:shadow-xl hover:shadow-rose-200/50 hover:ring-rose-200">
                        {/* Top accent */}
                        <div className="absolute left-0 right-0 top-0 h-1 bg-gradient-to-r from-rose-300 via-rose-500 to-rose-300" />
                        ...
                        <div className="mb-6 flex items-center gap-4">
                            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-rose-500 to-rose-600 shadow-md shadow-rose-300/40 transition-transform duration-300 group-hover:scale-110">
                                <FontAwesomeIcon icon={faEye} className="h-6 w-6 text-white" />
                            </div>
                            <div>
                                <p className="text-[10px] font-semibold uppercase tracking-[0.25em] text-rose-400">
                                    ビジョン
                                </p>
                        ...
                        <div
                            aria-hidden="true"
                            className="absolute -bottom-4 -right-4 h-20 w-20 rounded-full bg-rose-100/60 transition-transform duration-500 group-hover:scale-150"
                        />
                        <SakuraPetal className="absolute bottom-3 right-3 h-8 w-8 text-rose-300/40 transition-all duration-500 group-hover:rotate-45 group-hover:text-rose-400/50" />
                    </div>
        ...
        <section id="lokasi" className="bg-white/50 py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid items-start gap-10 lg:grid-cols-5">
                    ...
                    <div className="relative overflow-hidden rounded-3xl shadow-xl shadow-rose-100/50 ring-1 ring-rose-100 lg:col-span-3">
                        {/* Top accent */}
            ...
            {socialLinks.map((social) => (
                ...
                >
                    ...
                    <div className="min-w-0">
                        <p className={cn('text-[10px] font-semibold uppercase tracking-widest', social.colorClass)}>
                            {social.label}
                        </p>
